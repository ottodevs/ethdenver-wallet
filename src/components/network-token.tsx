...
export function ReceiveModal({ open, onOpenChange }: ReceiveModalProps) {
    ...
    // Fetch token list
    const { data: tokenList, error: tokenListError } = useSWR<TokenList>(TOKEN_LISTS.default, fetchTokenList, {
        ...
        <div className='space-y-4'>
            <div className='flex justify-center py-4'>
                <div className='overflow-hidden rounded-lg bg-white p-2'>
                    {qrCodeDataUrl ? (
                        ...
                        <div className='bg-muted flex h-[250px] w-[250px] items-center justify-center'>
            ...
            <div className='space-y-2'>
                ...
                <div className='flex items-center space-x-2'>
                    <div className='bg-muted flex-1 overflow-hidden rounded-md p-2 text-sm'>
            ...
            {showAdvancedOptions && (
                <div className='space-y-4 pt-2'>
                    ...
                    <div className='space-y-2'>
                        ...
                        {!selectedChain && <p className='text-muted-foreground text-xs'>Please select a chain first</p>}
                    </div>
                </div>
            )}
        </div>
